...
class TestDataAPI_get_cal(unittest.TestCase):
    ...
    def setUp(self):
        self.test_path = r'test/equan_test/fdata/'   # 当前用例的路径
        self.data_path = r'test/equan_test/fdata/fund_data'  # 测试文件存放路径
    ...
    def test_get_cal_bylist(self):
        ...
        """
        # 测试正常取出
        dates = fd.get_cal(start='2020-01-01', end='2020-01-05')
        self.assertListEqual(['2020-01-02', '2020-01-03'], dates)

        # 测试，参数日期格式错误的情况
        dates = fd.get_cal(start='20200101', end='20200105')
    ...
    def test_get_cal_bydf(self):
        ...
        df = fd.get_cal(start='2020-01-01', end='2020-01-02', return_type='df', only_trade_date=False)
