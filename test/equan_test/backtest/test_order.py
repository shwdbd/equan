...
class Test_StockOrder(unittest.TestCase):
    ...
    def test_order_by_amount(self):
        ...
        self.assertEqual('20191105-000001', order1.order_id)
        self.assertIsNotNone(order1.get_account())
        self.assertEqual(self.context.now, order1.order_time)
        self.assertEqual(6.19, order1.order_price)   # 价格
        ...
        self.assertEqual('20191105-000002', order2.order_id)
        self.assertEqual(6.19, order2.order_price)   # 价格
        ...
        self.assertEqual("close", order2.offset_flag)
    ...
    def test_order_by_amount_with_error_symbol(self):
        ...
        self.assertEqual('20191105-000001', order.order_id)  # TODO 此处要改进
        ...
        self.assertEqual("订单被拒绝，原因：股票600099.SH不在可交易的资产池中，不能下单", order.state_message)
    ...
    def test_order_by_amount_with_wrong_amount(self):
        ...
        self.assertEqual(api.OrderState.REJECTED, order.state)     # 状态
        self.assertEqual(
            "订单被拒绝，原因：股票单交易数量必须以100为单位(amount=123)", order.state_message)
